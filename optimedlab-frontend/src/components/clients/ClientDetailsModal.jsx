...
const ClientDetailsModal = ({ client, onClose }) => {
  ...
  // Default elegant Indigo brand color for clients
              ...
              {client.image ? (
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = "https://via.placeholder.com/112?text=NA";
                  }}
                />
              ) : (
                <div
            ...
            <div className="bg-gray-50/50 p-5 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center text-gray-700">
                  <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center mr-3 text-blue-500 shrink-0">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
                ...
                <div className="flex items-center text-gray-700">
                  <div className="w-8 h-8 rounded-full bg-emerald-50 flex items-center justify-center mr-3 text-emerald-500 shrink-0">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <a
                    ...
                    className="text-sm font-medium hover:text-emerald-600 transition-colors truncate"
                  >
                    {client.phone}
                  </a>
                </div>
                ...
                <div className="text-sm font-medium">
                  ...
                  (client.address.street ||
                    ...
                    <div className="space-y-1 text-gray-600">
                      ...
                      <p className="font-bold text-gray-800 uppercase tracking-wide mt-1">
                        {client.address.country}
                      </p>
                    </div>
                  ) : (
